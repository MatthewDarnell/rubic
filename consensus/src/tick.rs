...
fn create_tick_verify_bytes() {
    ...
    assert_eq!(bytes, [179, 1, 162, 0, 78, 218, 145, 1, 0, 0, 55, 43, 1, 27, 5, 25, 182, 148, 180, 150, 
        ...
        212, 239, 220, 177, 78, 162, 18, 153, 203, 141, 98]
    );
    let hash = t.hash();
    assert_eq!(hash, 
               [4, 211, 243, 121, 112, 2, 33, 198, 50, 202, 209, 51, 219, 190, 182, 16, 76, 217, 175, 223, 36, 38, 24, 93, 189, 176, 196, 12, 126, 88, 156, 199]);
