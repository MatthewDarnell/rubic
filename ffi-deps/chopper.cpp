...
/*
    ...
    const unsigned long long PARAMETER_d[4] = { 0x0000000000000142, 0x00000000000000E4, 0xB3821488F1FC0C8D, 0x5E472F846657E0FC };
    const unsigned long long curve_order[4] = { CURVE_ORDER_0, CURVE_ORDER_1, CURVE_ORDER_2, CURVE_ORDER_3 };
    const unsigned long long Montgomery_Rprime[4] = { 0xC81DB8795FF3D621, 0x173EA5AAEA6B387D, 0x3D01B7C72136F61C, 0x0006A5F16AC8F9D3 };
    const unsigned long long ONE[4] = { 1, 0, 0, 0 };

    // Fixed GF(p^2) constants for the endomorphisms
    unsigned long long ctau1[4] = { 0x74DCD57CEBCE74C3, 0x1964DE2C3AFAD20C, 0x12, 0x0C };
    unsigned long long ctaudual1[4] = { 0x9ECAA6D9DECDF034, 0x4AA740EB23058652, 0x11, 0x7FFFFFFFFFFFFFF4 };
    unsigned long long cphi0[4] = { 0xFFFFFFFFFFFFFFF7, 0x05, 0x4F65536CEF66F81A, 0x2553A0759182C329 };
    unsigned long long cphi1[4] = { 0x07, 0x05, 0x334D90E9E28296F9, 0x62C8CAA0C50C62CF };
    unsigned long long cphi2[4] = { 0x15, 0x0F, 0x2C2CB7154F1DF391, 0x78DF262B6C9B5C98 };
    unsigned long long cphi3[4] = { 0x03, 0x02, 0x92440457A7962EA4, 0x5084C6491D76342A };
    unsigned long long cphi4[4] = { 0x03, 0x03, 0xA1098C923AEC6855, 0x12440457A7962EA4 };
    unsigned long long cphi5[4] = { 0x0F, 0x0A, 0x669B21D3C5052DF3, 0x459195418A18C59E };
    unsigned long long cphi6[4] = { 0x18, 0x12, 0xCD3643A78A0A5BE7, 0x0B232A8314318B3C };
    unsigned long long cphi7[4] = { 0x23, 0x18, 0x66C183035F48781A, 0x3963BC1C99E2EA1A };
    unsigned long long cphi8[4] = { 0xF0, 0xAA, 0x44E251582B5D0EF0, 0x1F529F860316CBE5 };
    unsigned long long cphi9[4] = { 0xBEF, 0x870, 0x14D3E48976E2505, 0xFD52E9CFE00375B };
    unsigned long long cpsi1[4] = { 0xEDF07F4767E346EF, 0x2AF99E9A83D54A02, 0x13A, 0xDE };
    unsigned long long cpsi2[4] = { 0x143, 0xE4, 0x4C7DEB770E03F372, 0x21B8D07B99A81F03 };
    unsigned long long cpsi3[4] = { 0x09, 0x06, 0x3A6E6ABE75E73A61, 0x4CB26F161D7D6906 };
    unsigned long long cpsi4[4] = { 0xFFFFFFFFFFFFFFF6, 0x7FFFFFFFFFFFFFF9, 0xC59195418A18C59E, 0x334D90E9E28296F9 };

    // Precomputed integers for fast-Babai rounding
    unsigned long long ell1[4] = { 0x259686E09D1A7D4F, 0xF75682ACE6A6BD66, 0xFC5BB5C5EA2BE5DF, 0x07 };
    unsigned long long ell2[4] = { 0xD1BA1D84DD627AFB, 0x2BD235580F468D8D, 0x8FD4B04CAA6C0F8A, 0x03 };
    unsigned long long ell3[4] = { 0x9B291A33678C203C, 0xC42BD6C965DCA902, 0xD038BF8D0BFFBAF6, 0x00 };
    unsigned long long ell4[4] = { 0x12E5666B77E7FDC0, 0x81CBDC3714983D82, 0x1B073877A22D8410, 0x03 };
    ...
    const unsigned long long FIXED_BASE_TABLE[960] = {
    ...
    const unsigned long long DOUBLE_SCALAR_TABLE[3072] = {
      0xe18a34f3a703e631, 0x287460bf1d502b5f, 0xe02e62f7e4f90353, 0x0c3ba0378b86acde, 0x90bf0f98b0937edc, 0x740b7c7824f0c555, 0xb321239123a01366, 0x4ffcf5b93a9557a5, 0x297afccbabda42bb, 0x5948d137556c97c6, 0xa8189a393330684c, 0x0caf2b720a341f27
    ...
    void table_lookup_fixed_base(point_precomp_t P, unsigned int digit, unsigned int sign)
    ...
    void multiply(const unsigned long long* a, const unsigned long long* b, unsigned long long* c)
    {
    ...
    void Montgomery_multiply_mod_order(const unsigned long long* ma, const unsigned long long* mb, unsigned long long* mc)
    ...
    void eccmadd(point_precomp_t Q, point_extproj_t P)
    ...
    void ecc_tau(point_extproj_t P)
    ...
    void ecc_tau_dual(point_extproj_t P)
    ...
    void ecc_delphidel(point_extproj_t P)
    ...
    void ecc_delpsidel(point_extproj_t P)
    ...
    void eccneg_extproj_precomp(point_extproj_precomp_t P, point_extproj_precomp_t Q)
    { // Point negation
    ...
    void eccneg_precomp(point_precomp_t P, point_precomp_t Q)
    { // Point negation
        *((__m256i*) & Q->t2) = *((__m256i*) & P->t2);
        *((__m256i*) & Q->yx) = *((__m256i*) & P->xy);
        *((__m256i*) & Q->xy) = *((__m256i*) & P->yx);
    ...
    unsigned long long mul_truncate(unsigned long long* s, unsigned long long* C)
    {
    ...
    void decompose(unsigned long long* k, unsigned long long* scalars)
    ...
    void wNAF_recode(unsigned long long scalar, unsigned int w, char* digits)
    ...
    bool ecc_mul_double(unsigned long long* k, unsigned long long* l, point_t Q)
    ...
    void cofactor_clearing(point_extproj_t R)
    { // Co-factor clearing
    ...
    bool decode(const unsigned char* Pencoded, point_t P)
    { // Decode point P
