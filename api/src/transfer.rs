...
fn create_transfer_and_check_txid() {
    ...
    let expected: Vec<u8> = vec![
       ...
       0, 0,
       //signature: u64
       236, 150, 80, 235, 217, 146, 162, 147, 122, 96, 97, 35, 221, 137, 78, 69, 31, 36, 63, 142, 33, 233, 186, 102, 174, 52, 246, 86, 142, 222, 70, 209, 
       104, 232, 248, 117, 171, 251, 153, 64, 223, 52, 223, 71, 140, 215, 207, 115, 169, 251, 12, 125, 121, 119, 88, 243, 91, 220, 245, 34, 77, 88, 41, 0
    ];

    assert_eq!(t.as_bytes().as_slice(), expected.as_slice());
    assert_eq!(t.txid().as_str(), "vggmwwrnnitmocoqslwhxzkqsfcebcmtfobowhjqlcqtzztumabbmrmfmqkl");
}
...
fn create_another_transfer() {
    ...
    let expected: Vec<u8> = vec![
      ...
      233, 237, 170,   0,
        ...
        /*begin signature */
        4, 85, 219, 231, 228, 57, 67, 21, 92, 44, 221, 91, 2, 223, 
        189, 6, 168, 202, 196, 85, 187, 166, 237, 83, 74, 118, 207,
        89, 199, 17, 145, 90, 178, 110, 113, 195, 119, 163, 122, 146,
        18, 133, 12, 208, 193, 108, 177, 19, 80, 67, 14, 250, 131, 
        229, 35, 36, 46, 236, 139, 69, 62, 206, 19, 0
        /*
       250, 222, 115, 210,
...
fn create_transfer_from_signed_vars() {
    ...
    let expected: Vec<u8> = vec![
        ...
        233, 237, 170,   0,
        0,   0,   0,   0,
        /*begin signature */ 4, 85, 219, 231, 228, 57, 67, 21, 92, 
        44, 221, 91, 2, 223, 189, 6, 168, 202, 196, 85, 187, 166, 
        237, 83, 74, 118, 207, 89, 199, 17, 145, 90, 178, 110, 113, 
        195, 119, 163, 122, 146, 18, 133, 12, 208, 193, 108, 177, 
        19, 80, 67, 14, 250, 131, 229, 35, 36, 46, 236, 139, 69, 62,
        206, 19, 0];
